...
## Other Requirements:-
1. Browser Supported are chrome, brave
2. Metamask browser extension and gnache
    
## setup process 

1. Clone the project
```
git clone https://github.com/G8ur/Fake-Product-Identification
```
...
```
truffle compile  (if installed truffle using npm then use npx truffle compile)
```
4. Open Ganache, (to setup local blockchain)
    - crerate new workspace
    - add truffle-config.js  in truffle project 
    - change port to 7545 in server settings (same as port in truffle-config.js)
5. In browser, open metamask 
...
```
truffle migrate (npx truffle migrate (if installed truffle using npm))
```
